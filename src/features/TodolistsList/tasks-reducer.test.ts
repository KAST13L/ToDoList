...
test('correct task should be added to correct array', () => {
    ...
    const action = addTaskTC.fulfilled({task}, 'request', {title: task.title, todolistId: task.todoListId})
...
test('status of specified task should be changed', () => {
    const action = updateTaskTC.fulfilled({taskId: '2', model: {status: TaskStatuses.New}, todolistId: 'todolistId2'},'requestId', {taskId: '2', domainModel: {status: TaskStatuses.New}, todolistId: 'todolistId2'})
...
test('title of specified task should be changed', () => {
    const action = updateTaskTC.fulfilled({taskId: '2', model: {title: 'yogurt'}, todolistId: 'todolistId2'},'requestId', {taskId: '2', domainModel: {title: 'yogurt'}, todolistId: 'todolistId2'})
